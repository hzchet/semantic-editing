...
from src.models.stylegan2.model import PixelNorm, Generator
from .modules import attention_mapping
...
class DynamicMapper(Module):
    def __init__(self):
        super().__init__()
        self.att_mapper = nn.ModuleList([AttModule() for _ in range(4)])
